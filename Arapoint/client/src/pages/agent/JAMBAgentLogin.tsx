...
export default function JAMBAgentLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/jamb-agent/login', {
        method: 'POST',
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-gray-900 dark:to-gray-800 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">JAMB Agent Login</CardTitle>
          <CardDescription>JAMB Service Agent Portal</CardDescription>
        </CardHeader>
        <CardContent>
