...
export default function AdminForgotPassword() {
  ...
  const handleSendOtp = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!email) {
      toast({ title: "Error", description: "Please enter your admin email address", variant: "destructive" });
      return;
    }
    setIsLoading(true);
    try {
      ...
      setStep('reset');
      startResendCooldown();
      toast({ title: "Code Sent", variant: "success", description: "If that admin email is registered, a 6-digit reset code has been sent to it." });
    } catch {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 to-blue-50 p-4">
        <Card className="w-full max-w-md border-2 border-indigo-200 shadow-xl">
          ...
          <CardContent>
            <Button className="w-full bg-indigo-600 hover:bg-indigo-700" onClick={() => navigate("/admin/login")}>
              Go to Admin Login
            </Button>
          </CardContent>
        </Card>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 to-blue-50 p-4">
      <Card className="w-full max-w-md border-2 border-indigo-200 shadow-xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Enter your admin email address and we'll send you a 6-digit reset code.
          </CardDescription>
        </CardHeader>
        <CardContent>
