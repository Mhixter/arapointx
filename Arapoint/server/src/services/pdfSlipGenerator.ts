...
> = {
  ...
  long: {
    ...
    firstname_size: "17px",
    middlename_top: "15.3%",
    middlename_left: "30.5%",
    middlename_size: "13px",
    dob_top: "",
    dob_left: "",
    dob_size: "",
    nin_top: "14.9%",
    ...
    field_configs: {
      ...
      nin: { font_family: "'Times New Roman', serif", font_weight: "400" },
      sex: { font_family: "'Times New Roman', serif", font_weight: "400" },
      tracking_id: { font_family: "'Times New Roman', serif", font_weight: "400" },
      address: { font_family: "'Times New Roman', serif", font_weight: "400" },
    },
