...
router.get('/performance', jambAgentAuthMiddleware, async (req: Request, res: Response) => {
  try {
    const agentId = (req as any).agentId;
    ...
    logger.error('JAMB agent performance error', { error: error.message });
